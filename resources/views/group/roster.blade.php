                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-5 text-right p-r-20 p-t-15">
                                @if(count($active_players) > 0)
                                    <a href="/roster/export" type="button" class="btn btn-info btn-cons"><i class="fa fa-download"></i>&nbsp;Download CSV</a>
                                @endif
                            </div>
                        </div>
                    </div>
                        ...
                        @if(count($active_players) > 0)
                            ...
                            <tr>
                                ...
                                <td class="v-align-middle text-center">
                                    <a href="/player/{{ $player->id }}/deactivate" class="btn btn-primary btn-cons btn-small" id="deactivate-{{ $player->id }}" data-toggle="tooltip" data-placement="left" title="Use this option if this player is no longer participating this season.">Deactivate</a>
                                </td>
                            </tr>
                            @endforeach
                        @else
