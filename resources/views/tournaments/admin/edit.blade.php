                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <div class="controls p-b-20 p-l-20">
                                    <div class="radio">
                                        <input id="active" type="radio" name="active" value="1" {{ ((old('active') == 1 || $tournament->isActive()) ? 'CHECKED' : '') }}>
                                        <label for="active"><strong>Active</strong></label> - makes the tournament visible, though registration dates are still obeyed.<br/>
                                        <input id="inactive" type="radio" name="active" value="0" {{ ((old('active') == 0 || $tournament->isInactive()) ? 'CHECKED' : '') }}>
