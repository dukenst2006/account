                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <div class="controls p-b-20 p-l-20">
                                    <div class="radio">
                                        <input id="active" type="radio" name="inactive" value="0" {{ ((old('inactive', null) === 0 || $tournament->isActive()) ? 'CHECKED' : '') }}>
                                        <label for="active"><strong>Active</strong></label> - makes the tournament visible, though registration dates are still obeyed.<br/>
                                        <input id="inactive" type="radio" name="inactive" value="1" {{ ((old('inactive', null) === 1 || $tournament->isInactive()) ? 'CHECKED' : '') }}>
