...
class StandaloneQuizmasterRegistrationRequest extends Request
{
    ...
    {
        return [
            'quizzed_at_tournament.required'        => "Please tell us how many times you've quizzed at tournament",
